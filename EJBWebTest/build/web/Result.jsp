...
<%@page import = "com.example.ejb.OperationSessionBean, javax.naming"%>
 
<%!
    private   OperationSessionBean ops = null;
    float result = 0;
    ...
    public void jspInit() {
        try {
            ...
            ops = (OperationSessionBean)ic.lookup(OperationSessionBean.class.getName());
